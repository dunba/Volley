...
function App() {
    ...
    const goalvids = [{ liked: true, description: 'Antonio Rudiger gives Chelsea crucial lead over Leicester City ', id: 0, active: 'true', team: 'Chelsea', url: rudigergoal, scorer: 'Antonio Rudiger', img: 'https://via.placeholder.com/300.png/09f/fff', comments: [{ name: 'bob', posting: 'first comment' }, { name: 'brad', posting: 'second comment' }, { name: 'brad', posting: 'third comment' }, { name: 'dunba', posting: '4th comment' }, { name: 'tester', posting: 'fifth comment' }, { name: 'steve', posting: '6th comment' }] }, { liked: true, description: 'Edinson Cavani gives Manchester United lead v Fulham in style ', id: 1, active: 'false', team: 'Manchester United', url: cavanigoal, scorer: 'Edinson Cavani', img: 'https://via.placeholder.com/300/12ds5a/808080', comments: [] }, { liked: false, description: 'Ferran Torres scorpion kick puts Manchester City ahead of Newcastle', id: 2, active: 'false', team: 'Manchester City', url: torresgoal, scorer: 'Ferran Torres', img: 'https://via.placeholder.com/300.png/0s06dsf/fff', comments: [] }, { liked: false, description: 'Steven Bergwijn slams Spurs into the lead v Aston Villa', id: 3, active: 'false', team: 'Tottenham', url: bergwigngoal, scorer: 'Steven Bergwign', img: 'https://via.placeholder.com/300/2200gg/808080', comments: [] }, { liked: false, description: 'Patrick Bamford breaks deadlock for Leeds United v Southampton', id: 4, active: 'false', team: 'Leeds', url: bamfordgoal, scorer: 'Patrick Bamford', img: 'https://via.placeholder.com/300/fkh544/808080', comments: [] }, { liked: true, description: 'Nicolas Pepe bags brace in Arsenal win over Crystal Palace', id: 5, active: 'false', team: 'Arsenal', url: pepegoal, scorer: 'Nicolas Pepe', img: 'https://via.placeholder.com/300/ffffff/808080', comments: [] }]
